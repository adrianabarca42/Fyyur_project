...
Revision ID: 0e0fd2a9b5ca
Revises: 
Create Date: 2020-11-17 18:22:36.081134
...
def upgrade():
    ...
    sa.Column('past_count', sa.Integer(), nullable=True),
    sa.Column('future_count', sa.Integer(), nullable=True),
